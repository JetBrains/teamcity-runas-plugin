...
{	
	...
	std::cout << std::endl << "\tJetBrains.runAs[32|64].exe configuration_arguments";
	...
	std::cout << std::endl << "\t\t/w:working_directory\t- is the current directory if it is not specified";
	std::cout << std::endl << "\t\t/c:configuration_file\t- is a text file, containing the other configuration arguments";
	...
	std::cout << std::endl << "\tJetBrains.runAs32.exe /c:myconfig.txt /p:MyPassword";
